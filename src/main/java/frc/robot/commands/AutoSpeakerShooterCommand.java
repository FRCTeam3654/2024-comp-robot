...
public class AutoSpeakerShooterCommand extends Command {
  ...
  public AutoSpeakerShooterCommand() {
  ...
  public void execute() {
    ...
    RobotContainer.speakerShooter.shootSpeaker(-95); // make it same as SpeakerShooterCommand
  ...
  public boolean isFinished() {
    if (shooterTimer + 1 < Timer.getFPGATimestamp()){
      return true;
    }
